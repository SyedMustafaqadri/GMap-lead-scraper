...
- **Status:** Four live-run issues found and fixed on 2026-08-30 (premature end on slow feed; phase 2 destroying the search session; dead Stop after SW suspension; Close-button SPA history reset). Latest commit `5441ead`, local only. Live re-verification pending.
